...
public class SpoilerRanges2 {
    ...
    public static void main(String[] args) {
        ...
        int[][] spoilerRanges = new int[n][2];

        for (int i = 0; i < n; i++) {
            spoilerRanges[i][0] = sc.nextInt();
            spoilerRanges[i][1] = sc.nextInt();
        }

        System.out.println(solution(message, spoilerRanges));
    }
}