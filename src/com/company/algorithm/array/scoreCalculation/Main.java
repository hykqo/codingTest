...
10
*
* count이라는 변수와 res라는 변수를 만든다.
* 반복문을 돌리면서 0이 나오지 않으면 +1씩 증가되도록 한다.
* 그 후 res에 현재 카운트를 담는다.
...
public class Main {
    public int result(int n, StringTokenizer st){
        int res = 0;
        int count = 0;
        for(int i = 0; i<n; i++){
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(m.result(n, st));
