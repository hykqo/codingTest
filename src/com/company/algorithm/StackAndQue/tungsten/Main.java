    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i< n.length(); i++){
            ...
            //닫는 괄호면 조건 체크
                ...
                //0. 아래는 닫는 괄호일때의 조건.
                //1. stack에 첫번째 값 무조건 빼기(짝궁인 여는괄호는 무조건 빼야 한다.) - 레이저는 없애야 하고, 텅스텐은 길이가 끝나면 없어져야 하기 때문
                //2. 인입받은 배열의 전 인덱스의 값이 '(' 이라면 stack의 남은 값을 텅스텐에 더한다.
                //3. 인입받은 배열의 전 인덱스의 값이 ')' 이라면 텅스텐을 더한다.
                stack.pop();
                if(n.charAt(i-1)=='(') tungsten += stack.size();
                else tungsten++;
            }
        }
